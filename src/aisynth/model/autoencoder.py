...
class ConvBlock1D(nn.Module):
    ...
    def __init__(
        ...
        self.layers = [
            nn.ReLU(),
            nn.Conv1d(
                n_in, n_hidden, (3,), stride=(1,), padding=padding, dilation=(dilation,)
            ),
            nn.ReLU(),
...
class EncoderBlock1D(nn.Module):
    ...
    def __init__(
        ...
        final_block = nn.Conv1d(width, output_emb_width, (3,), (1,), (1,))
...
class DecoderBlock1D(nn.Module):
    ...
    def __init__(
        ...
        first_block = nn.Conv1d(output_emb_width, width, (3,), (1,), (1,))
